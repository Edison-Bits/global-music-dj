  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-zinc-100 font-sans overflow-x-hidden flex flex-col selection:bg-red-600/30 selection:text-red-200">
      ...
      <main className="w-full flex-grow relative pb-20">
        ...
        {/* ESTADO 1: PORTADA COMPLETA (HERO) */}
        {!seccionAbierta && (
          <div className="animate-fade-in">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#09090b] via-[#09090b]/50 to-[#09090b]/20 z-0"></div>
              ...
              <div className="relative z-10 text-center px-4 flex flex-col items-center">
                ...
                <h2 className="text-6xl md:text-8xl lg:text-9xl font-black tracking-tighter uppercase leading-[0.9] text-white drop-shadow-2xl">
                  PERU <br/> 
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-800">MUSIC DJ</span>
                </h2>
                {/* Párrafo eliminado aquí */}
              </div>

              {/* Indicador de scroll (opcional, da buen look a pantalla completa) */}
        ...
        {/* CONTENEDOR PARA SECCIONES (Con margen max-w) */}
        <div className="max-w-7xl mx-auto w-full px-4">
            {/* ESTADO 2: SECCIÓN ABIERTA */}
            {seccionAbierta && (
            <section className="py-12 transition-all duration-500 animate-fade-in-up">
