      ...
      {!seccionAbierta ? (
        ...
        <div className="max-w-6xl mx-auto px-6 py-12 animate-in fade-in duration-500">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {seccionAbierta === 'Pack' ? (
              /* TARJETA CON LA IMAGEN "portada-ayacucho.jpg" */
              <div className="bg-[#0a0f1a] border border-zinc-800 p-6 rounded-[2rem] relative group hover:border-red-600/50 transition-all shadow-2xl overflow-hidden">
                ...
                {/* IMAGEN DE PORTADA QUE SUBISTE A PUBLIC */}
